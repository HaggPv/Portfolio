...
|---|------------------------------------------------------------------------------------------|---------------|-------------|
|01 |<br>[Анализ маркетинговой ситуации для развлекательного приложения](01_Marketing_Analysis_for_an_Entertainment_App)<br><br>|Определить причины неэффективности рекламы.\ Оценить Retention Rate, CR, LTV, CAC, ROI.\ Рекомендовать меры по выводу рекламных кампаний на уровень прибыли.|Python, matplotlib, pandas, seaborn, numpy|
