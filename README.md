...
|---|------------------------------------------------------------------------------------------|---------------|-------------|
<<<<<<< HEAD
|01 |<br>[Анализ маркетинговой ситуации для развлекательного приложения]01_(Marketing_Analysis_for_an_Entertainment_App)<br><br>|Определить причины неэффективности рекламы.\ Оценить Retention Rate, CR, LTV, CAC, ROI.\ Рекомендовать меры по выводу рекламных кампаний на уровень прибыли.|Python, matplotlib, pandas, seaborn, numpy|
...
>>>>>>> 6cb942994a1d4b4d7a78327938848b63208bfef4
